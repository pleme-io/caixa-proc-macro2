...
rec {
  ...
  workspaceMembers = {
    "bench-libproc-macro" = rec {
      packageId = "bench-libproc-macro";
    ...
    "proc-macro2-ui-test" = rec {
      packageId = "proc-macro2-ui-test";
      build = internal.buildRustCrateWithFeatures {
        packageId = "proc-macro2-ui-test";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "bench-libproc-macro" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./benches/bench-libproc-macro; };
        procMacro = true;
        libName = "bench_libproc_macro";
        libPath = "lib.rs";
        authors = [
      ...
      "proc-macro2-ui-test" = rec {
        crateName = "proc-macro2-ui-test";
        version = "0.0.1";
        edition = "2021";
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./tests/ui; };
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        devDependencies = [
